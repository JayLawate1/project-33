...
function setup() {
    ...
    miniG2= new Ground(330,300,250,20)

    block1=new Block(240,280,30,30)
    block2=new Block2(270,280,30,30)
    block3=new Block(300,280,30,30)
    block4=new Block2(330,280,30,30)
    block5=new Block(360,280,30,30)
    block6=new Block2(390,280,30,30)
    block7=new Block(420,280,30,30)

    block8=new Block(270,250,30,30)
    block9=new Block2(300,250,30,30)
    block10=new Block(330,250,30,30)
    block11=new Block2(360,250,30,30)
    block12=new Block(390,250,30,30)

    block13=new Block(300,220,30,30)
    block14=new Block2(330,220,30,30)
    block15=new Block(360,220,30,30)

    block16=new Block(330,190,30,30)
  ...
  block23=new Block(640,195,30,30)
    ...
    chain=new Chain(hexa,{x:80,y:250})
